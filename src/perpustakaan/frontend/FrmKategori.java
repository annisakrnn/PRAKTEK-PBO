...
if (row >= 0) {
    try {
        ...
        int idKategori = Integer.parseInt(model.getValueAt(row, 0).toString());

        Kategori kat = new Kategori().getById(idKategori);
        ...
        JOptionPane.showMessageDialog(this, "Kategori berhasil dihapus.", "Informasi", JOptionPane.INFORMATION_MESSAGE);
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "ID kategori tidak valid.", "Kesalahan", JOptionPane.ERROR_MESSAGE);
    }
} else {
    JOptionPane.showMessageDialog(this, "Pilih baris yang ingin dihapus.", "Kesalahan", JOptionPane.ERROR_MESSAGE);
}
